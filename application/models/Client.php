...
class Client extends CI_Model{
    ...
    */
     ...
     * @return boolean
     */
    public function update_last_login($client_id){
    ...
    */
    ...
    /**
     * Get some details about a client (stored in session)
     * @param type $email
     * @return boolean
     */
    ...
    * @return boolean
    */ 
    public function suspend($client_id, $new_status){
        $this->db->where('id', $client_id);
        $this->db->update('client', ['account_status'=>$new_status]);
    ...
    * @return boolean
    */
    public function delete($client_id, $new_value){
        $this->db->where('id', $client_id);
        $this->db->update('client', ['deleted'=>$new_value]);
    ...
    */
     ...
     * @return boolean
     */
    public function clientSearch($value){
    ...
    */
    ...
    public function update($client_id, $first_name, $last_name, $email, $mobile1, $mobile2, $role){
